...
const AdminMbledhesitHeader = ({presenter}) => {

    return (<div className="admin-mbledhesit-header-container">
        <TextField
            placeholder="Kërko"
        ...
        <Button variant="contained" color="error" onClick={() => {presenter.setDeletionModal(true, 'none')}} disabled={presenter?.bulkDeletionButtonDisabled}>
            <DeleteOutlineRounded/>
        </Button>
    </div>)
}

export default observer(AdminMbledhesitHeader);