export const TYPES = {
    ...
    MainAppRepository: Symbol.for('MainAppRepository'),
    ...
    //User
    UserHeaderPresenter: Symbol.for('UserHeaderPresenter'),
    UserSidebarPresenter: Symbol.for('UserSidebarPresenter'),
    UserBejPorosiPresenter: Symbol.for('UserBejPorosiPresenter'),
    UserPorositePresenter: Symbol.for('UserPorositePresenter'),
    UserPorosiaPresenter: Symbol.for('UserPorosiaPresenter'),
    //Admin
    AdminSidebarPresenter: Symbol.for('AdminSidebarPresenter'),
